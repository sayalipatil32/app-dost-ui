...
import { contactHeroData } from '@/data/ContactPage/contactHeroData';

export default function ContactHero() {
  const { tag, tagIcon: TagIcon, titleLine1, titleGradient, description, ctaPrimary, ctaSecondary, ctaSecondaryIcon: CtaSecIcon } = contactHeroData;
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button variant="outline" className="rounded-xl px-8 py-3 border-2 border-slate-300 hover:border-blue-500 text-slate-700 hover:text-blue-600 font-semibold">
                <CtaSecIcon className="mr-2 h-4 w-4" />
                {ctaSecondary}
              </Button>
            </div>
          </motion.div>
