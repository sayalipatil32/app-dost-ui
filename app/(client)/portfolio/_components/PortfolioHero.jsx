...
import { portfolioHeroData } from '@/data/PortfolioPage/portfolioHeroData';

export default function PortfolioHero() {
    const { tag, titleLine1, titleGradient, description, recentActivity, liveViewers } = portfolioHeroData;
    const LiveViewerIcon = liveViewers.icon;
