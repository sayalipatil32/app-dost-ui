'use client';
import { servicesHeroData } from '@/data/ServicePage/servicesHeroData';
import { motion } from 'framer-motion';

export default function ServicesHero() {
    const { tag, tagIcon: TagIcon, titleLine1, titleGradient, description, liveViewers } = servicesHeroData;
